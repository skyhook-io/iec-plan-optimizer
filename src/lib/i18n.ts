...
export const translations = {
  he: {
    ...
    instructionsStep2: 'עבור לאזור "צריכה חכמה"',
    instructionsStep2Detail: 'בתפריט הצריכה האישית',
    instructionsStep3: 'בחר טווח תאריכים',
    instructionsStep3Detail: 'מומלץ לבחור שנה שלמה',
    instructionsStep4: 'הורד כקובץ CSV',
    instructionsStep4Detail: 'ייצוא הנתונים לקובץ',
  ...
  en: {
    ...
    instructionsStep2: 'Go to "Smart Consumption"',
    instructionsStep2Detail: 'In the personal consumption menu',
    instructionsStep3: 'Select date range',
    instructionsStep3Detail: 'Recommended: select a full year',
    instructionsStep4: 'Download as CSV',
    instructionsStep4Detail: 'Export data to file',
